...
class RecipeTest < ActiveSupport::TestCase
    def setup
        @chef = Chef.create(chefname: "Alejandro", email: "arodriguez@arodriguezp.com")
        @recipe = @chef.recipes.build(name: "Chicken Parm", 
        summary: "this is the best chicken parm recipe ever",description: "heat,oil add anions , add tomato suce")
    end
